...
class ModelHiddenParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.endomoeg_scaffold_node_count = 256
        self.endomoeg_scaffold_knn = 4
        self.endomoeg_scaffold_max_node_offset_ratio = 0.02
        self.endomoeg_scaffold_max_radius_scale = 4.0
        self.endomoeg_scaffold_initial_gate_probability = 0.05
        self.lambda_scaffold_arap = 1e-2
        self.lambda_scaffold_acceleration = 1e-3
        self.lambda_scaffold_node_offset = 1e-3
        self.lambda_scaffold_gate_sparsity = 1e-3
        self.endomoeg_residual_hard_quantile = 0.7
        self.endomoeg_residual_reconstruction_weight = 1.0
        self.endomoeg_residual_boost_weight = 0.25
        self.endomoeg_residual_preserve_weight = 1.0
        self.endomoeg_residual_no_regret_weight = 2.0
        self.endomoeg_residual_no_regret_margin = 0.0
        self.endomoeg_residual_no_regret_temperature = 0.01
        self.endomoeg_residual_depth_weight = 0.05
        self.endomoeg_residual_lr_scale = 0.01
        self.endomoeg_residual_warmup_iterations = 500
        self.endomoeg_residual_gradient_clip = 0.05
        self.endomoeg_residual_max_baseline_psnr_drop = 0.05
        self.endomoeg_residual_render_parity_tolerance = 1e-5
        self.endomoeg_contact_anchor_count = 512
        self.endomoeg_contact_chart_count = 3
        self.endomoeg_contact_max_spatial_offset_ratio = 0.02
        self.endomoeg_contact_max_velocity_ratio = 0.05
        self.endomoeg_contact_max_acceleration_ratio = 0.05
        self.endomoeg_contact_max_rotation_radians = 0.5
        self.endomoeg_contact_max_scale_delta = 0.1
        self.endomoeg_contact_initial_duration = 0.15
        self.lambda_contact_bank_sparsity = 1e-4
        self.lambda_contact_bank_locality = 1e-3
        self.lambda_contact_bank_acceleration = 1e-3
        self.lambda_contact_bank_spatial_offset = 1e-3
        self.lambda_contact_bank_duration = 1e-4
        self.endomoeg_bundle_dir = ""
        self.endomoeg_canonical_bundle = ""
        self.endomoeg_router_bundle = ""
        self.endomoeg_min_expert_psnr = 0.0
        self.endomoeg_min_oracle_headroom = 0.3
        self.endomoeg_router_gaussian_lr = 0.05
        self.endomoeg_router_feature_lr = 0.005
        self.endomoeg_router_gain_temperature = 0.02
        self.endomoeg_router_lambda_gain = 0.1
        self.endomoeg_router_lambda_sparsity = 1e-3
        self.endomoeg_router_lambda_no_regret = 0.5
