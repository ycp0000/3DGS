...
class CAMSGSTracking(nn.Module):
    ...
    def forward(
        ...
        aux = {
            ...
            "global_motion_norm": motion_state["global_motion_norm"],
            "local_motion_norm": motion_state["local_motion_norm"],
            "cut_graph_motion_norm": motion_state["cut_graph_motion_norm"],
